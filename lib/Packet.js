...
var Packet = function () {
  ...
  (0, _createClass3.default)(Packet, [{
    ...
    value: function isLocal() {
      ...
      return !!this.origin.address && (_ref = []).concat.apply(_ref, (0, _toConsumableArray3.default)((0, _values2.default)(os.networkInterfaces()))).some(function (_ref2) {
    ...
    value: function split() {
      ...
      one.header = (0, _assign2.default)({}, this.header);
      two.header = (0, _assign2.default)({}, this.header);
      ...
      if (this.isAnswer()) {
        ...
        one.setAdditionals((_ref3 = []).concat.apply(_ref3, (0, _toConsumableArray3.default)(one.answers.map(function (a) {
          return a.additionals;
        }))));
        two.setAdditionals((_ref4 = []).concat.apply(_ref4, (0, _toConsumableArray3.default)(two.answers.map(function (a) {
          return a.additionals;
        }))));
      }
