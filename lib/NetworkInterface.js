...
NetworkInterface.prototype = (0, _create2.default)(EventEmitter.prototype);
...
NetworkInterface.getLoopback = function getLoopback() {
  ...
  return (0, _keys2.default)(interfaces).find(function (name) {
...
NetworkInterface.prototype._bindSocket = function () {
  ...
  var promise = new _promise2.default(function (resolve, reject) {
    ...
    socket.on('listening', function () {
      ...
      var addresses = (_ref = []).concat.apply(_ref, (0, _toConsumableArray3.default)((0, _values2.default)(os.networkInterfaces())));

      [].concat((0, _toConsumableArray3.default)(new _set2.default(addresses))).filter(function (add) {
...
NetworkInterface.prototype._addToCache = function (packet) {
  ...
  var incomingRecords = [].concat((0, _toConsumableArray3.default)(packet.answers), (0, _toConsumableArray3.default)(packet.additionals));
...
NetworkInterface.prototype.send = function (packet, destination, callback) {
  ...
  if (packet.isAnswer() && !destination) {
    ...
    this._history.addEach([].concat((0, _toConsumableArray3.default)(packet.answers), (0, _toConsumableArray3.default)(packet.additionals)));
  }
