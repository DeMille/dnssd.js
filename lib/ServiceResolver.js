...
var ServiceResolver = function (_StateMachine) {
  (0, _inherits3.default)(ServiceResolver, _StateMachine);

  function ServiceResolver(fullname, intf) {
    (0, _classCallCheck3.default)(this, ServiceResolver);

    debug('Creating new resolver for "' + fullname + '"');

    var _this2 = (0, _possibleConstructorReturn3.default)(this, (ServiceResolver.__proto__ || (0, _getPrototypeOf2.default)(ServiceResolver)).call(this, resovlverStates));
  ...
  (0, _createClass3.default)(ServiceResolver, [{
    key: 'start',
    ...
    value: function service() {
      ...
      this._service.txt = this.txt ? (0, _assign2.default)({}, this.txt) : {};
      this._service.txtRaw = this.txtRaw ? (0, _assign2.default)({}, this.txtRaw) : {};
    ...
    value: function _onAnswer(packet) {
      this.handle('incomingRecords', [].concat((0, _toConsumableArray3.default)(packet.answers), (0, _toConsumableArray3.default)(packet.additionals)));
    }
    ...
    value: function _checkCache(questions) {
      ...
      questions.forEach(function (question, index) {
        ...
        if (results && results.length) {
          ...
          answers.push.apply(answers, (0, _toConsumableArray3.default)(results));
        }
      });
