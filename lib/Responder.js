...
var ConflictCounter = function () {
  function ConflictCounter() {
    (0, _classCallCheck3.default)(this, ConflictCounter);

    this._count = 0;
    this._timer = null;
  }

  (0, _createClass3.default)(ConflictCounter, [{
    key: 'count',
...
var Responder = function (_StateMachine) {
  (0, _inherits3.default)(Responder, _StateMachine);

  function Responder(intf, records, bridgeable) {
    (0, _classCallCheck3.default)(this, Responder);

    var _this4 = (0, _possibleConstructorReturn3.default)(this, (Responder.__proto__ || (0, _getPrototypeOf2.default)(Responder)).call(this, responderStates));

    _this4._id = uniqueId();
    debug('Creating new responder (%s) using: %r', _this4._id, records);

    var uniques = [].concat((0, _toConsumableArray3.default)(new _set2.default(records.filter(function (r) {
      return r.isUnique;
    }).map(function (r) {
      return r.name;
    }))));
  ...
  (0, _createClass3.default)(Responder, [{
    ...
    value: function _onAnswer(packet) {
      ...
      var incoming = new RecordCollection([].concat((0, _toConsumableArray3.default)(packet.answers), (0, _toConsumableArray3.default)(packet.additionals)));
