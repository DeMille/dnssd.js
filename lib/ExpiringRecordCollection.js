...
var ExpiringRecordCollection = function (_EventEmitter) {
  (0, _inherits3.default)(ExpiringRecordCollection, _EventEmitter);
  ...
  function ExpiringRecordCollection(records, description) {
    (0, _classCallCheck3.default)(this, ExpiringRecordCollection);

    // make debugging easier, who owns this / what it is
    var _this = (0, _possibleConstructorReturn3.default)(this, (ExpiringRecordCollection.__proto__ || (0, _getPrototypeOf2.default)(ExpiringRecordCollection)).call(this));
  ...
  (0, _createClass3.default)(ExpiringRecordCollection, [{
    key: 'add',
    value: function add(record) {
      ...
      if (!this._related[group]) this._related[group] = new _set2.default();
    ...
    value: function clear() {
      ...
      (0, _values2.default)(this._timerContainers).forEach(function (timers) {
        return timers.clear();
      });
    ...
    value: function toArray() {
      return (0, _values2.default)(this._records);
    }
    ...
    value: function _getRelatedRecords(namehash) {
      ...
      return this._related[namehash] && this._related[namehash].size ? [].concat((0, _toConsumableArray3.default)(this._related[namehash])).map(function (id) {
