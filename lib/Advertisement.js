...
Advertisement.prototype = (0, _create2.default)(EventEmitter.prototype);
  ...
  return new _promise2.default(function (resolve, reject) {
    ...
    _this5._interface.on('query', function handler(packet) {
      if (packet.isLocal() && packet.equals(queryPacket)) {
        self._defaultAddresses = (0, _values2.default)(os.networkInterfaces()).find(function (intf) {
...
Advertisement.prototype._advertiseHostname = function () {
  ...
  var interfaces = (0, _values2.default)(os.networkInterfaces());

  var records = this._makeAddressRecords(this._defaultAddresses);
  var bridgeable = (_ref2 = []).concat.apply(_ref2, (0, _toConsumableArray3.default)(interfaces.map(function (i) {
...
Advertisement.prototype._makeAddressRecords = function (addresses) {
  ...
  As.forEach(function (A) {
    A.additionals = AAAAs.length ? [].concat((0, _toConsumableArray3.default)(AAAAs), [NSEC]) : [NSEC];
  });

  AAAAs.forEach(function (AAAA) {
    AAAA.additionals = As.length ? [].concat((0, _toConsumableArray3.default)(As), [NSEC]) : [NSEC];
  });

  return [].concat((0, _toConsumableArray3.default)(As), (0, _toConsumableArray3.default)(AAAAs), [NSEC]);
};
...
Advertisement.prototype._makeServiceRecords = function () {
  ...
  var SRV = new ResourceRecord.SRV({
    ...
    port: this.port,
    additionals: [NSEC].concat((0, _toConsumableArray3.default)(interfaceRecords))
  });
  ...
  records.push(new ResourceRecord.PTR({
    ...
    additionals: [SRV, TXT, NSEC].concat((0, _toConsumableArray3.default)(interfaceRecords))
  }));
