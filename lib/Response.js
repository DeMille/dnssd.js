...
MulticastResponse.prototype = (0, _create2.default)(EventEmitter.prototype);
...
GoodbyeResponse.prototype = (0, _create2.default)(MulticastResponse.prototype);
...
UnicastResponse.prototype = (0, _create2.default)(EventEmitter.prototype);
...
UnicastResponse.prototype._makePacket = function () {
  ...
  additionals = [].concat((0, _toConsumableArray3.default)(new _set2.default(additionals)));
