...
Probe.prototype = (0, _create2.default)(EventEmitter.prototype);
...
Probe.prototype._onProbe = function (packet) {
  ...
  (0, _keys2.default)(local).forEach(function (key) {
  ...
  var hasConflict = (0, _keys2.default)(local).some(function (name) {
