...
Browser.prototype = (0, _create2.default)(EventEmitter.prototype);
...
Browser.prototype.stop = function () {
  ...
  (0, _values2.default)(this._resolvers).forEach(function (resolver) {
...
Browser.prototype.list = function () {
  ...
  if (this._isWildcard) {
    return (0, _values2.default)(this._serviceTypes);
  }

  return (0, _values2.default)(this._resolvers).filter(function (resolver) {
